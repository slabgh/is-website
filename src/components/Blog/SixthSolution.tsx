      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            ...
            >
              <Image
                src="/images/solutions/phone-call.svg"
                alt="about image"
                fill
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            <SectionTitle
                title="Toll Free SMS/Call"
                paragraph="A toll-free number is on indispensable asset that helps businesses grow over time. It allows your customers to call your business for free.

The Toll-Free Short Message Service (Toll-Free SMS) also enables you to send text messages from your Toll-Free number to clients.

A Toll-Free number inspires trust. Take advantage of this trusted channel to enable two-way conversations and engage with more customers!"
                mb="44px"
              />
              {/* <div className="mb-9">
