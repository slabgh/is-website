          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                ...
                paragraph="iSmart’s mobile money management platform provides SOHOs, SMEs &. Enterprises with convenient and accessible ways to monitor and control their finances using mobile devices. Our services include features such as account management, budgeting tools, fund transfers, bill payments, and notifications. SOHOs, SMEs &. Enterprises can easily track their income, expenses, and savings."                
                mb="44px"
              />
